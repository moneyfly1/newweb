...
export const markOrderPaid = (id: number) => request.post(`/admin/orders/${id}/mark-paid`)
export const completeOrder = (id: number) => request.post(`/admin/orders/${id}/complete`)
export const batchOrderAction = (data: { ids: number[], action: string }) => request.post('/admin/orders/batch-action', data)
